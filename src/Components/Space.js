...
// L'idea è quella di spostare le cose all'interno di space per
// far si che il personaggio non si duplichi  cercare di capire 
//come funziona use effect?
...
<div className='container'>
    ...
    <h1>3D Landing page with three.js</h1>
    <p>Landing page using Three.js, javascript, React. Please use arrows to move inside the page</p>
   
   
    <button  className="button-start" onClick={() => {navigate("/environment")}}>Start Now</button>
    </div>
